...
class KategoriPengaduanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $kategori_pengaduan = [
            ...
            [
                'nama' => 'Pembangunan Desa, Daerah Tertinggal, dan Termigrasi',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'nama' => 'Pendidikan dan Kebudayaan',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
            ...
            [
                'nama' => 'Energi dan Sumber Daya Alam',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'nama' => 'Kekerasan di Satuan Pendidikan (Sekolah, Kampus, Lembaga Kursus)',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
        ...
        KategoriPengaduan::insert($kategori_pengaduan);
    }
}
