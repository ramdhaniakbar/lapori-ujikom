            ...
            <div class="card">
              ...
              <div class="card-content collapse hide">
                <div class="card-body card-dashboard">
                  ...
                  <form class="form form-horizontal" action="{{ route('backsite.tanggapan.store') }}" method="POST">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 mx-auto">
                          ...
                          <textarea name="isi_tanggapan" id="isi_tanggapan" cols="30" rows="10" class="form-control"
                            placeholder="contoh Baik, akan kami diskusikan" autocomplete="off"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 mx-auto">
                          <input type="date" id="tanggal_tanggapan" name="tanggal_tanggapan" class="form-control"
                            placeholder="example admin or users" value="{{old('tanggal_tanggapan')}}" autocomplete="off"
                            required>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 mx-auto">
                          <select name="pengaduan_id" id="pengaduan_id" class="select2 form-control">
                          ...
                          <td class="text-center">
                            ...
                            <div class="btn-group mr-1 mb-1">
                              ...
                              <div class="dropdown-menu">
                                <a href="#mymodal" data-remote="{{ route('backsite.pengaduan.show', $pengaduan->id) }}"
                                  data-toggle="modal" data-target="#mymodal" data-title="Detail Pengaduan"
                                  class="dropdown-item">
                                  Show
                                </a>
                                ...
                                <form action="{{ route('backsite.pengaduan.status_selesai', $pengaduan->id) }}"
                                  method="POST"
                                  onsubmit="return confirm('Apa kamu yakin ingin menolak pengaduan ini?');">
                                  <input type="hidden" name="_method" value="PUT">
                                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                  <input type="submit" class="dropdown-item" value="Selesai">
                                </form>
                                @endif

                                @if ($pengaduan->status != 'ditolak')
                                <form action="{{ route('backsite.pengaduan.tolak_status', $pengaduan->id) }}"
                                  method="POST"
                                  onsubmit="return confirm('Apa kamu yakin ingin menolak pengaduan ini?');">
                                  <input type="hidden" name="_method" value="PUT">
                                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                  <input type="submit" class="dropdown-item" value="Tolak">
                                </form>
                                @else
                                <form action="{{ route('backsite.pengaduan.status_kembali', $pengaduan->id) }}"
                                  method="POST"
                                  onsubmit="return confirm('Apa kamu yakin ingin mengembalikan status pengaduan ini?');">
                                  <input type="hidden" name="_method" value="PUT">
                                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                  <input type="submit" class="dropdown-item" value="Kembalikan Status">
                                </form>
                                @endif
