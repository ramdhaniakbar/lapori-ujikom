        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">Kategori Pengaduan</li>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" id="horz-layout-basic">Edit Kategori Pengaduan</h4>
              ...
              <div class="card-content collpase show">
                <div class="card-body">
                  ...
                  <form class="form form-horizontal" action="{{ route('backsite.kategori_pengaduan.update',
                    [$kategori_pengaduan->id]) }}" method="POST">
                    ...
                    <div class="form-body">
                      ...
                      <h4 class="form-section"><i class="fa fa-edit"></i>Form Kategori Pengaduan</h4>

                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="name">Nama Kategori<code
                            style="color:red;">required</code></label>
                        <div class="col-md-9 mx-auto">
                          <input type="text" id="name" name="nama" class="form-control" placeholder="contoh Kesehatan"
                            value="{{ isset($kategori_pengaduan) ? $kategori_pengaduan->nama : '' }}" autocomplete="off"
                            required>
